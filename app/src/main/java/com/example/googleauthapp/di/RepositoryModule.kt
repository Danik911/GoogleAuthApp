...
import com.example.googleauthapp.util.Constants.DATASTORE_PREFERENCES_FILE_NAME
...
object RepositoryModule {
    ...
    fun provideDatastore(@ApplicationContext context: Context): DataStore<Preferences> {
        return PreferenceDataStoreFactory.create(
            produceFile = { context.preferencesDataStoreFile(DATASTORE_PREFERENCES_FILE_NAME) }
        )
    }
